...
import { Tabbable } from "@ui5/webcomponents-base/dist/delegate/ItemNavigation.js";
import { isSpace, isEnter, isSpaceShift } from "@ui5/webcomponents-base/dist/Keys.js";
import Icon from "@ui5/webcomponents/dist/Icon2.js";
...
class ProductSwitchItem extends UI5Element implements Tabbable {
	_deactivate: () => void;
	active?: boolean;
	selected?: boolean;
	focused?: boolean;
